...
import { getElementByDataTestId, getElementByType, getElementByName } from "../../cypressUtils";
...
describe("/recipes", () => {
    ...
    it("Able to search recipes with query 'onion'", () => {
        ...
        cy.get(getElementByDataTestId("SearchIcon")).click().wait(1000).then(() => {
            cy.get("[data-testid='recipeTitle']").first().contains('Charred spring onions');
        });
    });
    ...
    it("Able to search recipes with multiple queries 'onion' & 'garlic'", () => {
        ...
        cy.get(getElementByDataTestId("SearchIcon")).click().wait(1000).then(() => {
            cy.get("[data-testid='recipeTitle']").first().contains('How to Make Homemade Re-fried Beans');
        });
    });
    ...
    it("Able to search recipes with query 'onion' and see detail of recipe", () => {
        ...
        cy.get(getElementByDataTestId("SearchIcon")).click().wait(1000).then(() => {
            ...
            cy.get("[data-testid='recipeItemCard'").first().click().wait(1000).then(() => {
    ...
    it("Able to search recipes with query 'onion' and add to my recipe", () => {
        ...
        cy.get(getElementByName("query")).type("onion");
        cy.get(getElementByDataTestId("SearchIcon")).click().wait(1000).then(() => {
            cy.get("[data-testid='addRecipeButton']").first().click().wait(1000).then(() => {
                visitMyRecipe();
                cy.get("[data-testid='recipeTitle']").contains('Charred spring onions');
            });
        });
    });
    ...
    it('Able to search recipes with my fridge items', () => {
        ...
        cy.get("[data-testid='searchedResults']").children().first().find("[type=button]").click().wait(1000).then(() => {
            ...
            cy.get("[data-testid='searchedResults']").children().first().find("[type=button]").click().wait(1000).then(() => {
                ...
                cy.get("input").first().invoke('attr', 'placeholder').should('contain', 'onion, garlic');
                cy.get("[data-testid='recipeTitle']").first().contains('How to Make Homemade Re-fried Beans');
        ...
        cy.get("[data-testid='searchedResults']").children().first().find("[type=button]").click().wait(1000).then(() => {
            ...
            cy.get("[data-testid='searchedResults']").children().first().find("[type=button]").click().wait(1000).then(() => {
                ...
                cy.get("[data-testid='searchedResults']").children().first().find("[type=button]").click().wait(1000).then(() => {
                    visitRecipes();
                    cy.get("[type=button]").click().wait(1000);
                    cy.get("input").first().invoke('attr', 'placeholder').should('contain', 'onion, garlic, pasta');
    ...
    it('Able to search recipes with my fridge items and then search with new query text', () => {
        ...
        cy.get("[data-testid='searchedResults']").children().first().find("[type=button]").click().wait(1000).then(() => {
            ...
            cy.get("[data-testid='searchedResults']").children().first().find("[type=button]").click().wait(1000).then(() => {
                ...
                cy.get(getElementByDataTestId("SearchIcon")).click().wait(1000).then(() => {
                    cy.get("[data-testid='recipeTitle']").contains('Apple Ginger Kombucha Cocktail');
